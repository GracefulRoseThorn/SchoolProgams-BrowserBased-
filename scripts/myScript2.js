...
//Class in prototype form
function Win(name) {
  this.name = name;
}
//gets class Win and adds to it in class print (inheritance)
Win.prototype.print = function() {
  alert('Congragulations you win! your score: '+this.name);
}
...
//gets class Lost and adds to it in class print2 (inheritance)
Lost.prototype.print2 = function() {
  alert('Game Over, ran out of lives! your score: '+this.name);
}
